    ...
    <div className={cn("border-b border-ops-line bg-ops-surface", className)}>
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 px-6 pb-5 pt-6">
        <div className="min-w-0">
          <h1 className="text-display font-medium tracking-[-0.02em] text-ops-text">{title}</h1>
        ...
        return (
          ...
          >
            ...
            {t.count !== undefined && t.count > 0 && (
              <span className="ops-num rounded-full bg-ops-active px-2 text-micro font-medium text-ops-text-tertiary">
                {t.count}
              </span>
            )}
          </button>
